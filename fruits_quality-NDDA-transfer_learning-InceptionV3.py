# fruits_quality-NDDA-transfer_learning-InceptionV3.py
#
...
history= new_Inception_model.fit(train_generator,
                        validation_data = validation_generator,
                        epochs=epochs, verbose=1)

#new_VGG16_model.save('InceptionV3_TransferLearning_NDDA.h5')
...
pyplot.savefig('fruits_quality-NDDA-InceptionV3-training_acc-4.png')
pyplot.show()
...
pyplot.savefig('fruits_quality-NDDA-InceptionV3-training_loss-4.png')
pyplot.show()
...
pyplot.savefig('fruits_quality-NDDA-InceptionV3-confusion-matrix-4.png')
pyplot.show()
