# fruits_quality-NDDA-transfer_learning-MobileNet.py
#
...
history= new_MobileNet_model.fit(train_generator,
                        validation_data = validation_generator,
                        epochs=epochs, verbose=1)

#new_VGG16_model.save('MobileNet_TransferLearning_NDDA.h5')
...
pyplot.savefig('fruits_quality-NDDA-MobileNet-training_acc.png')
#pyplot.show()
...
pyplot.savefig('fruits_quality-NDDA-MobileNet-training_loss.png')
#pyplot.show()
...
pyplot.savefig('fruits_quality-NDDA-MobileNet-confusion-matrix.png')
#pyplot.show()
